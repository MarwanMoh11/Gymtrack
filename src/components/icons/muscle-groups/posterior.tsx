...
export default function PosteriorView({ onMuscleClick, getMuscleClass, ...props }: MuscleViewProps) {
  return (
    <svg
      ...
      {...props}
    >
      <g id="posterior-view" transform="translate(20, 0)">
        <path
          id="post-traps"
        ...
        <path
          ...
          d="M198.2,156.7v38.8h-79.6V156.7L130.6,145l37.7-10.6l31.5,13.3V156.7z"
        />
        <path
          id="post-lats"
          className={getMuscleClass('Lats')}
          onClick={() => onMuscleClick('Lats')}
          d="M216.4,195.5v72.2h-18.9v-60h-79.6v60h-18.9V195.5h117.4z"
        />
        <path
          id="post-rear-delts"
          className={getMuscleClass('Rear Delts')}
          onClick={() => onMuscleClick('Rear Delts')}
          d="M231.6,156.7l-14.5,38.8h-18.9l14.5-38.8H231.6z M102.8,156.7l14.5,38.8h18.9l-14.5-38.8H102.8z"
        />
        <path
          id="post-triceps"
        ...
        <path
          ...
          d="M186.5,267.7v41.8h-74.8V267.7H186.5z"
        />
        <path
          id="post-glutes"
          className={getMuscleClass('Glutes')}
          onClick={() => onMuscleClick('Glutes')}
          d="M206.5,309.5v52.2h-38.8v-52.2h-24.8v52.2h-38.8v-52.2H206.5z"
        />
        <path
          id="post-hamstrings"
          className={getMuscleClass('Hamstrings')}
          onClick={() => onMuscleClick('Hamstrings')}
          d="M186.5,361.7v100h-24.8v-100h-24.8v100h-24.8v-100H186.5z"
        />
        <path
          id="post-calves"
          className={getMuscleClass('Calves')}
          onClick={() => onMuscleClick('Calves')}
          d="M186.5,461.7v60h-24.8v-60h-24.8v60h-24.8v-60H186.5z"
        />
      </g>
    </svg>
  );
