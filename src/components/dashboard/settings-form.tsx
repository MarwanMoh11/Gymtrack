        ...
        <div className="w-full max-w-3xl mx-auto py-6 space-y-8">
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Exit your current session on this device.</CardDescription>
                </CardHeader>
                <CardContent>
                    <Button
                        variant="outline"
                        className="w-full sm:w-auto rounded-xl border-primary/20 hover:bg-primary/10 transition-all duration-300 gap-2"
                        onClick={async () => {
                            await logout();
                            router.push('/login');
                        }}
