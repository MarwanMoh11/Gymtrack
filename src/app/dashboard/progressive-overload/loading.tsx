    ...
    <div className="container mx-auto py-8 px-4 md:px-6 space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-8">
           <Card className="shadow-lg rounded-2xl h-full"> {/* Match height behavior */}
              <CardHeader>
              ...
              <CardContent className="flex-grow flex items-center justify-center p-4"> 
                 {/* Use aspect-video or a large fixed height to simulate filling space */}
        ...
        <div className="lg:col-span-1">
          <Card className="shadow-lg rounded-2xl">
            <CardHeader>
               <div className="flex justify-between items-center"> {/* Align title and removed button space */}
