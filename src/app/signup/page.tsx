      ...
      <Card className="glass-panel border-none shadow-none rounded-3xl overflow-hidden animate-in zoom-in-95 fade-in duration-500 delay-200 fill-mode-both">
        <CardHeader className="pt-8 pb-4 text-center">
          ...
          <CardDescription className="text-muted-foreground">
            Join thousands of others reaching their goals
          </CardDescription>
        </CardHeader>
        <CardContent className="px-6 pb-8">
          <Form {...form}>
            <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="text-xs uppercase tracking-wider font-semibold opacity-70">Confirm Password</FormLabel>
                    <FormControl>
                      <Input
                        type="password"
                        placeholder="••••••••"
              ...
              <Button
                type="submit"
                className="w-full h-12 text-sm font-bold uppercase tracking-widest rounded-xl bg-primary hover:bg-primary/90 transition-all shadow-xl shadow-primary/20 mt-2 interactive-scale"
                disabled={isLoading || isGoogleLoading}
              >
          ...
          <Button
            variant="outline"
            className="w-full h-11 bg-white/5 border-white/10 hover:bg-white/10 rounded-xl transition-all interactive-scale"
