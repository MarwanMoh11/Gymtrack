  ...
  },
  {
    ...
    exercises: [
      ...
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/ANVdMDaD5iA', muscleGroups: ['Lower Rectus Abdominis'],
        sets: [
          { id: 'ogcb-d4-core3-s1', targetReps: '30-60', unit: 's' },
          { id: 'ogcb-d4-core3-s2', targetReps: '30-60', unit: 's' },
          { id: 'ogcb-d4-core3-s3', targetReps: '30-60', unit: 's' },
        ],
        notes: 'Dedicated Core Work (Choose 2-3).',
      },
    ],
    ...
    exercises: [
      ...
      },
      {
        id: 'cal-mon-skill-hs-v2', name: 'Handstand Push-Ups', isSkill: true, unit: 'reps', description: 'An advanced calisthenics exercise that involves doing a push-up while in a handstand position against a wall. The ultimate bodyweight shoulder exercise.', videoUrl: 'https://www.youtube.com/embed/d_M-v-g_FFI', muscleGroups: ['Deltoids', 'Triceps', 'Traps'], sets: [
          { id: 'jn-d5e5s1', targetReps: 'To Failure' }, { id: 'jn-d5e5s2', targetReps: 'To Failure' }, { id: 'jn-d5e5s3', targetReps: 'To Failure' }
        ]
      },
      {
    ...
    exercises: [
      {
        ...
        sets: [{ id: 'lib-bp-s1', targetReps: '6-10' }, { id: 'lib-bp-s2', targetReps: '6-10' }, { id: 'lib-bp-s3', targetReps: '6-10' }, {id: 'lib-bp-s4', targetReps: '6-10' }],
      },
      {
        ...
        sets: [{ id: 'lib-incline-bp-s1', targetReps: '8-12' }, { id: 'lib-incline-bp-s2', targetReps: '8-12' }, { id: 'lib-incline-bp-s3', targetReps: '8-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-decline-bp-s1', targetReps: '8-12' }, { id: 'lib-decline-bp-s2', targetReps: '8-12' }, { id: 'lib-decline-bp-s3', targetReps: '8-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-db-bp-s1', targetReps: '8-12' }, { id: 'lib-db-bp-s2', targetReps: '8-12' }, { id: 'lib-db-bp-s3', targetReps: '8-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-incline-db-bp-s1', targetReps: '8-12' }, { id: 'lib-incline-db-bp-s2', targetReps: '8-12' }, { id: 'lib-incline-db-bp-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Lower Pectoralis', 'Triceps', 'Deltoids'],
        sets: [{ id: 'lib-decline-db-bp-s1', targetReps: '8-12' }, { id: 'lib-decline-db-bp-s2', targetReps: '8-12' }, { id: 'lib-decline-db-bp-s3', targetReps: '8-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-db-flys-s1', targetReps: '10-15' }, { id: 'lib-db-flys-s2', targetReps: '10-15' }, { id: 'lib-db-flys-s3', targetReps: '10-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-incline-db-flys-s1', targetReps: '12-15' }, { id: 'lib-incline-db-flys-s2', targetReps: '12-15' }, { id: 'lib-incline-db-flys-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-cable-crossovers-high-s1', targetReps: '12-15' }, { id: 'lib-cable-crossovers-high-s2', targetReps: '12-15' }, { id: 'lib-cable-crossovers-high-s3', targetReps: '12-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/Iwe6AmxVf7o',
        muscleGroups: ['Upper Pectoralis', 'Serratus Anterior'],
        sets: [{ id: 'lib-cable-crossovers-low-s1', targetReps: '12-15' }, { id: 'lib-cable-crossovers-low-s2', targetReps: '12-15' }, { id: 'lib-cable-crossovers-low-s3', targetReps: '12-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/IODxDxX7oi4',
        muscleGroups: ['Pectoralis Major', 'Triceps', 'Deltoids'],
        sets: [{ id: 'lib-push-ups-s1', targetReps: 'To Failure' }, { id: 'lib-push-ups-s2', targetReps: 'To Failure' }, { id: 'lib-push-ups-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        muscleGroups: ['Lower Pectoralis', 'Triceps', 'Deltoids'],
        sets: [{ id: 'lib-chest-dips-s1', targetReps: 'To Failure' }, { id: 'lib-chest-dips-s2', targetReps: 'To Failure' }, { id: 'lib-chest-dips-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        muscleGroups: ['Pectoralis Major', 'Triceps', 'Deltoids'],
        sets: [{ id: 'lib-machine-chest-press-s1', targetReps: '10-15' }, { id: 'lib-machine-chest-press-s2', targetReps: '10-15' }, { id: 'lib-machine-chest-press-s3', targetReps: '10-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-pec-deck-machine-s1', targetReps: '12-15' }, { id: 'lib-pec-deck-machine-s2', targetReps: '12-15' }, { id: 'lib-pec-deck-machine-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-dumbbell-pullovers-s1', targetReps: '10-15' }, { id: 'lib-dumbbell-pullovers-s2', targetReps: '10-15' }, { id: 'lib-dumbbell-pullovers-s3', targetReps: '10-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-dl-s1', targetReps: '3-6' }, { id: 'lib-dl-s2', targetReps: '3-6' }, { id: 'lib-dl-s3', targetReps: '3-6' }],
      },
      {
        ...
        sets: [{ id: 'lib-sumo-dl-s1', targetReps: '3-6' }, { id: 'lib-sumo-dl-s2', targetReps: '3-6' }, { id: 'lib-sumo-dl-s3', targetReps: '3-6' }],
      },
      {
        ...
        sets: [{ id: 'lib-pull-ups-s1', targetReps: 'To Failure' }, { id: 'lib-pull-ups-s2', targetReps: 'To Failure' }, { id: 'lib-pull-ups-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/b-2tM2n_p0M',
        muscleGroups: ['Latissimus Dorsi', 'Biceps', 'Rhomboids'],
        sets: [{ id: 'lib-chin-ups-s1', targetReps: 'To Failure' }, { id: 'lib-chin-ups-s2', targetReps: 'To Failure' }, { id: 'lib-chin-ups-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        sets: [{ id: 'lib-bent-over-rows-s1', targetReps: '6-10' }, { id: 'lib-bent-over-rows-s2', targetReps: '6-10' }, { id: 'lib-bent-over-rows-s3', targetReps: '6-10' }, { id: 'lib-bent-over-rows-s4', targetReps: '6-10' }],
      },
      {
        ...
        sets: [{ id: 'lib-pendlay-rows-s1', targetReps: '5-8' }, { id: 'lib-pendlay-rows-s2', targetReps: '5-8' }, { id: 'lib-pendlay-rows-s3', targetReps: '5-8' }],
      },
      {
        ...
        sets: [{ id: 'lib-db-rows-s1', targetReps: '8-12 per side' }, { id: 'lib-db-rows-s2', targetReps: '8-12 per side' }, { id: 'lib-db-rows-s3', targetReps: '8-12 per side' }],
      },
      {
        ...
        sets: [{ id: 'lib-t-bar-rows-s1', targetReps: '8-12' }, { id: 'lib-t-bar-rows-s2', targetReps: '8-12' }, { id: 'lib-t-bar-rows-s3', targetReps: '8-12' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/GZbfZ033f74',
        muscleGroups: ['Rhomboids', 'Latissimus Dorsi', 'Biceps'],
        sets: [{ id: 'lib-cable-rows-s1', targetReps: '10-15' }, { id: 'lib-cable-rows-s2', targetReps: '10-15' }, { id: 'lib-cable-rows-s3', targetReps: '10-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/0oe_dj_G9oU',
        muscleGroups: ['Latissimus Dorsi', 'Biceps'],
        sets: [{ id: 'lib-lat-pulldowns-s1', targetReps: '10-12' }, { id: 'lib-lat-pulldowns-s2', targetReps: '10-12' }, { id: 'lib-lat-pulldowns-s3', targetReps: '10-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-straight-arm-pulldowns-s1', targetReps: '12-15' }, { id: 'lib-straight-arm-pulldowns-s2', targetReps: '12-15' }, { id: 'lib-straight-arm-pulldowns-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-good-mornings-s1', targetReps: '8-12' }, { id: 'lib-good-mornings-s2', targetReps: '8-12' }, { id: 'lib-good-mornings-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Erector Spinae', 'Glutes', 'Hamstrings'],
        sets: [{ id: 'lib-back-extensions-s1', targetReps: '12-15' }, { id: 'lib-back-extensions-s2', targetReps: '12-15' }, { id: 'lib-back-extensions-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-rack-pulls-s1', targetReps: '3-6' }, { id: 'lib-rack-pulls-s2', targetReps: '3-6' }, { id: 'lib-rack-pulls-s3', targetReps: '3-6' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/hXTc1mDn2yY',
        muscleGroups: ['Rhomboids', 'Lats', 'Biceps', 'Posterior Deltoids'],
        sets: [{ id: 'lib-inverted-rows-s1', targetReps: 'To Failure' }, { id: 'lib-inverted-rows-s2', targetReps: 'To Failure' }, { id: 'lib-inverted-rows-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        sets: [{ id: 'lib-back-squats-s1', targetReps: '5-8' }, { id: 'lib-back-squats-s2', targetReps: '5-8' }, { id: 'lib-back-squats-s3', targetReps: '5-8' }],
      },
      {
        ...
        sets: [{ id: 'lib-front-squats-s1', targetReps: '6-10' }, { id: 'lib-front-squats-s2', targetReps: '6-10' }, { id: 'lib-front-squats-s3', targetReps: '6-10' }],
      },
      {
        ...
        muscleGroups: ['Quadriceps', 'Glutes', 'Core'],
        sets: [{ id: 'lib-goblet-squats-s1', targetReps: '10-15' }, { id: 'lib-goblet-squats-s2', targetReps: '10-15' }, { id: 'lib-goblet-squats-s3', targetReps: '10-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/s8-89_iT_aQ',
        muscleGroups: ['Quadriceps', 'Glutes', 'Hamstrings'],
        sets: [{ id: 'lib-leg-press-s1', targetReps: '10-15' }, { id: 'lib-leg-press-s2', targetReps: '10-15' }, { id: 'lib-leg-press-s3', targetReps: '10-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/2z8JmcrW-As',
        muscleGroups: ['Hamstrings', 'Glutes', 'Erector Spinae'],
        sets: [{ id: 'lib-rdls-s1', targetReps: '8-12' }, { id: 'lib-rdls-s2', targetReps: '8-12' }, { id: 'lib-rdls-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Quadriceps', 'Glutes', 'Hamstrings'],
        sets: [{ id: 'lib-walking-lunges-s1', targetReps: '10-12 per leg' }, { id: 'lib-walking-lunges-s2', targetReps: '10-12 per leg' }, { id: 'lib-walking-lunges-s3', targetReps: '10-12 per leg' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/2C-uNgKwPLE',
        muscleGroups: ['Quadriceps', 'Glutes', 'Hamstrings'],
        sets: [{ id: 'lib-bulgarian-split-squats-s1', targetReps: '8-12 per leg' }, { id: 'lib-bulgarian-split-squats-s2', targetReps: '8-12 per leg' }, { id: 'lib-bulgarian-split-squats-s3', targetReps: '8-12 per leg' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/YyvSfVjQeL0',
        muscleGroups: ['Quadriceps'],
        sets: [{ id: 'lib-leg-extensions-s1', targetReps: '12-15' }, { id: 'lib-leg-extensions-s2', targetReps: '12-15' }, { id: 'lib-leg-extensions-s3', targetReps: '12-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/1Tq3QdYUuHs',
        muscleGroups: ['Hamstrings'],
        sets: [{ id: 'lib-leg-curls-s1', targetReps: '12-15' }, { id: 'lib-leg-curls-s2', targetReps: '12-15' }, { id: 'lib-leg-curls-s3', targetReps: '12-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/Jfl_g_h_AnA',
        muscleGroups: ['Gastrocnemius', 'Soleus'],
        sets: [{ id: 'lib-standing-calf-raises-s1', targetReps: '15-25' }, { id: 'lib-standing-calf-raises-s2', targetReps: '15-25' }, { id: 'lib-standing-calf-raises-s3', targetReps: '15-25' }, { id: 'lib-standing-calf-raises-s4', targetReps: '15-25' }],
      },
      {
        ...
        muscleGroups: ['Soleus'],
        sets: [{ id: 'lib-seated-calf-raises-s1', targetReps: '15-25' }, { id: 'lib-seated-calf-raises-s2', targetReps: '15-25' }, { id: 'lib-seated-calf-raises-s3', targetReps: '15-25' }, { id: 'lib-seated-calf-raises-s4', targetReps: '15-25' }],
      },
      {
        ...
        muscleGroups: ['Glutes', 'Hamstrings'],
        sets: [{ id: 'lib-hip-thrusts-s1', targetReps: '8-12' }, { id: 'lib-hip-thrusts-s2', targetReps: '8-12' }, { id: 'lib-hip-thrusts-s3', targetReps: '8-12' }, { id: 'lib-hip-thrusts-s4', targetReps: '8-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-hack-squats-s1', targetReps: '10-15' }, { id: 'lib-hack-squats-s2', targetReps: '10-15' }, { id: 'lib-hack-squats-s3', targetReps: '10-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-box-jumps-s1', targetReps: '5-8' }, { id: 'lib-box-jumps-s2', targetReps: '5-8' }, { id: 'lib-box-jumps-s3', targetReps: '5-8' }],
      },
      {
        ...
        muscleGroups: ['Quadriceps'],
        sets: [{ id: 'lib-sissy-squats-s1', targetReps: 'To Failure' }, { id: 'lib-sissy-squats-s2', targetReps: 'To Failure' }, { id: 'lib-sissy-squats-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        sets: [{ id: 'lib-ohp-s1', targetReps: '6-10' }, { id: 'lib-ohp-s2', targetReps: '6-10' }, { id: 'lib-ohp-s3', targetReps: '6-10' }],
      },
      {
        ...
        sets: [{ id: 'lib-seated-db-press-s1', targetReps: '8-12' }, { id: 'lib-seated-db-press-s2', targetReps: '8-12' }, { id: 'lib-seated-db-press-s3', targetReps: '8-12' }],
      },
      {
        ...
        sets: [{ id: 'lib-arnold-press-s1', targetReps: '8-12' }, { id: 'lib-arnold-press-s2', targetReps: '8-12' }, { id: 'lib-arnold-press-s3', targetReps: '8-12' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/3VcKaXpzqRo',
        muscleGroups: ['Lateral Deltoids'],
        sets: [{ id: 'lib-lateral-raises-s1', targetReps: '12-15' }, { id: 'lib-lateral-raises-s2', targetReps: '12-15' }, { id: 'lib-lateral-raises-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-bent-over-db-raises-s1', targetReps: '12-15' }, { id: 'lib-bent-over-db-raises-s2', targetReps: '12-15' }, { id: 'lib-bent-over-db-raises-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-front-raises-s1', targetReps: '10-15' }, { id: 'lib-front-raises-s2', targetReps: '10-15' }, { id: 'lib-front-raises-s3', targetReps: '10-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-upright-rows-s1', targetReps: '10-12' }, { id: 'lib-upright-rows-s2', targetReps: '10-12' }, { id: 'lib-upright-rows-s3', targetReps: '10-12' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/eIq5CB9wyoE',
        muscleGroups: ['Posterior Deltoids', 'Rhomboids', 'Traps'],
        sets: [{ id: 'lib-face-pulls-s1', targetReps: '15-20' }, { id: 'lib-face-pulls-s2', targetReps: '15-20' }, { id: 'lib-face-pulls-s3', targetReps: '15-20' }],
      },
      {
        ...
        sets: [{ id: 'lib-barbell-shrugs-s1', targetReps: '8-12' }, { id: 'lib-barbell-shrugs-s2', targetReps: '8-12' }, { id: 'lib-barbell-shrugs-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Upper Trapezius'],
        sets: [{ id: 'lib-dumbbell-shrugs-s1', targetReps: '10-15' }, { id: 'lib-dumbbell-shrugs-s2', targetReps: '10-15' }, { id: 'lib-dumbbell-shrugs-s3', targetReps: '10-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-landmine-press-s1', targetReps: '8-12 per side' }, { id: 'lib-landmine-press-s2', targetReps: '8-12 per side' }, { id: 'lib-landmine-press-s3', targetReps: '8-12 per side' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/mYdOknQ_24M',
        muscleGroups: ['Deltoids', 'Triceps'],
        sets: [{ id: 'lib-pike-push-ups-s1', targetReps: 'To Failure' }, { id: 'lib-pike-push-ups-s2', targetReps: 'To Failure' }, { id: 'lib-pike-push-ups-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        muscleGroups: ['Lateral Deltoids'],
        sets: [{ id: 'lib-cable-lateral-raises-s1', targetReps: '12-15 per side' }, { id: 'lib-cable-lateral-raises-s2', targetReps: '12-15 per side' }, { id: 'lib-cable-lateral-raises-s3', targetReps: '12-15 per side' }],
      },
      {
        ...
        muscleGroups: ['Posterior Deltoids', 'Rhomboids'],
        sets: [{ id: 'lib-reverse-pec-deck-s1', targetReps: '12-15' }, { id: 'lib-reverse-pec-deck-s2', targetReps: '12-15' }, { id: 'lib-reverse-pec-deck-s3', targetReps: '12-15' }],
      },
      {
        ...
        muscleGroups: ['Deltoids', 'Triceps', 'Traps'],
        sets: [{ id: 'lib-handstand-push-ups-s1', targetReps: 'To Failure' }, { id: 'lib-handstand-push-ups-s2', targetReps: 'To Failure' }, { id: 'lib-handstand-push-ups-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        sets: [{ id: 'lib-barbell-curls-s1', targetReps: '8-12' }, { id: 'lib-barbell-curls-s2', targetReps: '8-12' }, { id: 'lib-barbell-curls-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Biceps Brachii'],
        sets: [{ id: 'lib-db-bicep-curls-s1', targetReps: '10-12 per side' }, { id: 'lib-db-bicep-curls-s2', targetReps: '10-12 per side' }, { id: 'lib-db-bicep-curls-s3', targetReps: '10-12 per side' }],
      },
      {
        ...
        sets: [{ id: 'lib-hammer-curls-s1', targetReps: '10-15' }, { id: 'lib-hammer-curls-s2', targetReps: '10-15' }, { id: 'lib-hammer-curls-s3', targetReps: '10-15' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/fIWP-FRFNU0',
        muscleGroups: ['Biceps Brachii'],
        sets: [{ id: 'lib-preacher-curls-s1', targetReps: '10-12' }, { id: 'lib-preacher-curls-s2', targetReps: '10-12' }, { id: 'lib-preacher-curls-s3', targetReps: '10-12' }],
      },
      {
        ...
        muscleGroups: ['Biceps Brachii'],
        sets: [{ id: 'lib-concentration-curls-s1', targetReps: '10-15 per side' }, { id: 'lib-concentration-curls-s2', targetReps: '10-15 per side' }],
      },
      {
        ...
        muscleGroups: ['Biceps Brachii'],
        sets: [{ id: 'lib-cable-curls-s1', targetReps: '12-15' }, { id: 'lib-cable-curls-s2', targetReps: '12-15' }, { id: 'lib-cable-curls-s3', targetReps: '12-15' }],
      },
      {
        ...
        sets: [{ id: 'lib-close-grip-bp-s1', targetReps: '6-10' }, { id: 'lib-close-grip-bp-s2', targetReps: '6-10' }, { id: 'lib-close-grip-bp-s3', targetReps: '6-10' }],
      },
      {
        ...
        sets: [{ id: 'lib-tri-pushdowns-s1', targetReps: '10-15' }, { id: 'lib-tri-pushdowns-s2', targetReps: '10-15' }, { id: 'lib-tri-pushdowns-s3', targetReps: '10-15' }],
      },
      {
        ...
        muscleGroups: ['Triceps Brachii'],
        sets: [{ id: 'lib-skull-crushers-s1', targetReps: '8-12' }, { id: 'lib-skull-crushers-s2', targetReps: '8-12' }, { id: 'lib-skull-crushers-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Triceps Brachii'],
        sets: [{ id: 'lib-overhead-tri-ext-s1', targetReps: '10-15' }, { id: 'lib-overhead-tri-ext-s2', targetReps: '10-15' }, { id: 'lib-overhead-tri-ext-s3', targetReps: '10-15' }],
      },
      {
        ...
        muscleGroups: ['Triceps', 'Pectoralis Major', 'Deltoids'],
        sets: [{ id: 'lib-triceps-dips-s1', targetReps: 'To Failure' }, { id: 'lib-triceps-dips-s2', targetReps: 'To Failure' }, { id: 'lib-triceps-dips-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        sets: [{ id: 'lib-diamond-push-ups-s1', targetReps: 'To Failure' }, { id: 'lib-diamond-push-ups-s2', targetReps: 'To Failure' }, { id: 'lib-diamond-push-ups-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        sets: [{ id: 'lib-wrist-curls-s1', targetReps: '15-20' }, { id: 'lib-wrist-curls-s2', targetReps: '15-20' }, { id: 'lib-wrist-curls-s3', targetReps: '15-20' }],
      },
      {
        ...
        sets: [{ id: 'lib-reverse-wrist-curls-s1', targetReps: '15-20' }, { id: 'lib-reverse-wrist-curls-s2', targetReps: '15-20' }, { id: 'lib-reverse-wrist-curls-s3', targetReps: '15-20' }],
      },
      {
        ...
        sets: [{ id: 'lib-farmers-walk-s1', targetReps: 'for distance/time' }, { id: 'lib-farmers-walk-s2', targetReps: 'for distance/time' }, { id: 'lib-farmers-walk-s3', targetReps: 'for distance/time' }],
      },
      {
        ...
        sets: [{ id: 'lib-plank-s1', targetReps: '30-60', unit: 's' }, { id: 'lib-plank-s2', targetReps: '30-60', unit: 's' }, { id: 'lib-plank-s3', targetReps: '30-60', unit: 's' }],
      },
      {
        ...
        sets: [{ id: 'lib-crunches-s1', targetReps: '15-25' }, { id: 'lib-crunches-s2', targetReps: '15-25' }, { id: 'lib-crunches-s3', targetReps: '15-25' }],
      },
      {
        ...
        sets: [{ id: 'lib-leg-raises-s1', targetReps: '15-20' }, { id: 'lib-leg-raises-s2', targetReps: '15-20' }, { id: 'lib-leg-raises-s3', targetReps: '15-20' }],
      },
      {
        ...
        sets: [{ id: 'lib-russian-twists-s1', targetReps: '15-20 per side' }, { id: 'lib-russian-twists-s2', targetReps: '15-20 per side' }, { id: 'lib-russian-twists-s3', targetReps: '15-20 per side' }],
      },
      {
        ...
        muscleGroups: ['Lower Rectus Abdominis', 'Obliques', 'Hip Flexors'],
        sets: [{ id: 'lib-hanging-knee-raises-s1', targetReps: 'To Failure' }, { id: 'lib-hanging-knee-raises-s2', targetReps: 'To Failure' }, { id: 'lib-hanging-knee-raises-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/Pr1ieGZ5atk',
        muscleGroups: ['Lower Rectus Abdominis', 'Obliques', 'Hip Flexors'],
        sets: [{ id: 'lib-hanging-leg-raises-s1', targetReps: 'To Failure' }, { id: 'lib-hanging-leg-raises-s2', targetReps: 'To Failure' }, { id: 'lib-hanging-leg-raises-s3', targetReps: 'To Failure' }],
      },
      {
        ...
        muscleGroups: ['Rectus Abdominis', 'Transverse Abdominis', 'Obliques'],
        sets: [{ id: 'lib-ab-rollouts-s1', targetReps: '8-12' }, { id: 'lib-ab-rollouts-s2', targetReps: '8-12' }, { id: 'lib-ab-rollouts-s3', targetReps: '8-12' }],
      },
      {
        ...
        muscleGroups: ['Obliques', 'Rectus Abdominis'],
        sets: [{ id: 'lib-cable-woodchops-s1', targetReps: '10-15 per side' }, { id: 'lib-cable-woodchops-s2', targetReps: '10-15 per side' }, { id: 'lib-cable-woodchops-s3', targetReps: '10-15 per side' }],
      },
      {
        ...
        videoUrl: 'https://www.youtube.com/embed/Z64142k_S84',
        muscleGroups: ['Obliques', 'Transverse Abdominis'],
        sets: [{ id: 'lib-side-plank-s1', targetReps: '30-45', unit: 's' }, { id: 'lib-side-plank-s2', targetReps: '30-45', unit: 's' }, { id: 'lib-side-plank-s3', targetReps: '30-45', unit: 's' }],
      },
      {
        ...
        sets: [{ id: 'lib-bicycle-crunches-s1', targetReps: '20-30 total' }, { id: 'lib-bicycle-crunches-s2', targetReps: '20-30 total' }, { id: 'lib-bicycle-crunches-s3', targetReps: '20-30 total' }],
      },
      {
        id: 'lib-flutter-kicks', name: 'Flutter Kicks', targetWeight: 'Bodyweight', unit: 's', isCore: true,
        description: 'Lying on your back with legs extended, you perform small, rapid up-and-down kicks, targeting the lower abs.',
        videoUrl: 'https://www.youtube.com/embed/ANVdMDaD5iA',
        muscleGroups: ['Lower Rectus Abdominis'],
        sets: [{ id: 'lib-flutter-kicks-s1', targetReps: '30-60', unit: 's' }, { id: 'lib-flutter-kicks-s2', targetReps: '30-60', unit: 's' }, { id: 'lib-flutter-kicks-s3', targetReps: '30-60', unit: 's' }],
      },
      {
        ...
        muscleGroups: ['Rectus Abdominis', 'Obliques'],
        sets: [{ id: 'lib-v-ups-s1', targetReps: '10-15' }, { id: 'lib-v-ups-s2', targetReps: '10-15' }, { id: 'lib-v-ups-s3', targetReps: '10-15' }],
      },
      {
        ...
        muscleGroups: ['Rectus Abdominis'],
        sets: [{ id: 'lib-decline-crunches-s1', targetReps: '15-20' }, { id: 'lib-decline-crunches-s2', targetReps: '15-20' }, { id: 'lib-decline-crunches-s3', targetReps: '15-20' }],
      },
      {
        ...
        muscleGroups: ['Rectus Abdominis'],
        sets: [{ id: 'lib-cable-crunches-s1', targetReps: '15-20' }, { id: 'lib-cable-crunches-s2', targetReps: '15-20' }, { id: 'lib-cable-crunches-s3', targetReps: '15-20' }],
      },
      {
        ...
        muscleGroups: ['Obliques', 'Transverse Abdominis'],
        sets: [{ id: 'lib-pallof-press-s1', targetReps: '10-12 per side' }, { id: 'lib-pallof-press-s2', targetReps: '10-12 per side' }, { id: 'lib-pallof-press-s3', targetReps: '10-12 per side' }],
      },
    ],
  }];
